...
export default class ImageGallery extends Component {
  ...
  componentDidUpdate(prevProps, prevState) {
    if (
      ...
      fetch(
        `https://pixabay.com/api/?q=${this.props.searchName}&page=${this.state.page}&key=25358610-6c58710bcb07b0c67b61215e4&image_type=photo&orientation=horizontal&per_page=12`
      )
        ...
        .then(resultArray =>
          this.setState({
            imageArray: this.state.imageArray.concat(resultArray.hits),
          })
        )
